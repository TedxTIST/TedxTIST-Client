...
const slides: Slide[] = [
  ...
  { id: "13", name: "Joyel Sebastian", role: "Social Media Coordinator", image: "/team/Joyel Sebastian.heic" },
  { id: "14", name: "Ganga Gireesh", role: "Design Lead", image: "/team/Ganga Gireesh.heif" },
